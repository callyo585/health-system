    ...
    return (
      <form onSubmit={handleSubmit} noValidate>
        <section className="modal-card-body">
          ...
          <div className="columns is-mobile">
            <div className="column is-one-fifth">
              Email {signup ? <span className="has-text-danger">*</span> : null}{" "}
              :
            </div>
            <div className="column">
              <input
              ...
              <div className="field has-addons">
                <p className="control">
                  <input
                    className="input is-info"
                    type="number"
                    placeholder="e.g. 160.1"
                    name="height"
                    onChange={handleChange}
                    value={
                      signup && signupDetails
                        ? signupDetails.height
                        : profileData.height
                    }
                  />
                </p>
              ...
              <div className="field has-addons">
                <p className="control">
                  <input
                    className="input is-info"
                    type="number"
                    placeholder="e.g. 80.6"
                    name="weight"
                    onChange={handleChange}
                    value={
                      signup && signupDetails
                        ? signupDetails.weight
                        : profileData.weight
                    }
                  />
                </p>
          ...
          {signup ? (
            <React.Fragment>
              <div className="columns is-mobile">
                <div className="column is-one-fifth">
                  Password
                  {signup ? <span className="has-text-danger">*</span> : null} :
                </div>
                <div className="column">
                  <input
                    className="input is-info"
                    ...
                    onChange={handleChange}
                    value={
                      signup && signupDetails ? signupDetails.password : ""
                    }></input>
                </div>
              </div>
              <div className="columns is-mobile">
                ...
                <div className="column">
                  <input
                    ...
                    onChange={handleChange}
                    value={
                      signup && signupDetails ? signupDetails.confirmPass : ""
                    }></input>
                </div>
              </div>
              <div className="columns is-mobile">
            ...
            <div className="columns is-mobile">
              <div className="column is-one-fifth">Anxiety :</div>
              <div className="column is-one-fourth">
                <div className="field has-addons">
                  <p className="control">
                    {signup && signupDetails
              ...
              <div className="column is-one-fifth">Depression :</div>
              <div className="column is-one-fourth">
                <div className="field has-addons">
                  <p className="control">
                    {signup && signupDetails
                      ? signupDetails.weight
                      : profileData.depression}
                  </p>
                </div>
              </div>
              <div className="column is-one-fifth">Stress :</div>
              <div className="column is-one-fourth">
                <div className="field has-addons">
                  <p className="control">
                    {signup && signupDetails
        ...
        <footer className="modal-card-foot">
          <button
            id={signup ? "signupButton" : "updateButton"}
            type="submit"
